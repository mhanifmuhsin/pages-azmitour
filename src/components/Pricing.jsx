export default function Pricing({paket}) {
  return (
    <div id="pricing" className="bg-white">
      <div className="pt-36 px-4 sm:px-6 lg:px-8 lg:pt-36">
      ...
      <div className="mt-16 bg-white pb-12 lg:mt-20 lg:pb-20">
        ...
        {/*                  <span className="mt-2 mr-2 text-4xl font-medium">Rp.</span>*/}
        {/*                  <span className="font-extrabold">100.000</span>*/}
        {/*                </span>*/}
        {/*                <span className="text-2xl font-medium text-gray-500">/orang</span>*/}
        {/*              </div>*/}
        {/*            </div>*/}
        {/*          </div>*/}

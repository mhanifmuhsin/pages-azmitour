        ...
        <div className="py-12 px-4 sm:px-6 md:flex md:flex-col md:py-16 md:pl-0 md:pr-10 md:border-r md:border-gray-100 lg:pr-16">
          ...
          <blockquote className="mt-6 md:flex-grow md:flex md:flex-col">
            <div className="relative text-lg font-medium text-white md:flex-grow">
              <svg
                className="absolute top-0 left-0 transform -translate-x-3 -translate-y-2 h-8 w-8 text-gray-500"
                fill="currentColor"
                viewBox="0 0 32 32"
                aria-hidden="true"
              >
              ...
              <p className="relative">
                Wisata ziarah kali ini dipimpin dari azmi tour Alhamdulillah
                diberikan lancar dan sehat semuanya, dan ga pernah kecewa dengan
                unit dan fasilitas yang diberikan selalu yang terbaik
              </p>
            </div>
        ...
        <div className="py-12 px-4 border-t-2 border-gray-200 sm:px-6 md:py-16 md:pr-0 md:pl-10 md:border-t-0 md:border-l lg:pl-16">
          ...
          <blockquote className="mt-6 md:flex-grow md:flex md:flex-col">
            <div className="relative text-lg font-medium text-white md:flex-grow">
              ...
              <p className="relative">
                Azmi tour sukses terus ya, unit dan pelayanannya memuaskan sekali
              </p>
            </div>
            <footer className="mt-8">
              <div className="flex items-start">
